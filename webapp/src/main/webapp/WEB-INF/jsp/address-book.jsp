  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img id="image-profile-sidebar" src="${addressBookData.user.pictureLink}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="<c:url value="/home/profile" />" class="d-block">${addressBookData.user.firstName} ${addressBookData.user.lastName}</a>
        </div>
      </div>
      ...
      <!-- Sidebar Menu -->
       <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="<c:url value="/home/${addressBookData.user.id}" />" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<c:url value="/home/user/calendar/${addressBookData.user.id}" />" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<c:url value="/home/user/profile/${addressBookData.user.id}" />" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<c:url value="/home/user/address/book/${addressBookData.user.id}" />" class="nav-link">
        	...
        	<div class="card">
              ...
              <div class="card-body p-0">
                <table class="table table-striped">
                  ...
                  <tbody>
                    <c:forEach var="friend" items="${addressBookData.friends}">
                  	  <tr>
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Akssh Goyal</h3>

                <p class="text-muted text-center">akashgoyal@gmail.com</p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Groups</b> <a class="float-right">5</a>
                  </li>
                  <li class="list-group-item">
                    <b>Friends</b> <a class="float-right">230</a>
                  </li>
                </ul>
              </div>
              <!-- /.card-body -->
