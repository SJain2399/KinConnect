      ...
      <!-- Sidebar Menu -->
       <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="<c:url value="/home/${userProfilePageData.user.id}" />" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<c:url value="/home/user/calendar/${userProfilePageData.user.id}" />" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<c:url value="/home/user/profile/${userProfilePageData.user.id}" />" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<c:url value="/home/user/address/book/${userProfilePageData.user.id}" />" class="nav-link">
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">${userProfilePageData.user.firstName} ${userProfilePageData.user.lastName}</h3>

                <p class="text-muted text-center">${userProfilePageData.user.email}</p>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                  ${userProfilePageData.user.birthDate}
                </p>
                ...
                <p class="text-muted">${userProfilePageData.user.location}</p>

                <hr>

                <strong><i class="far fa-file-alt mr-1"></i> Bio</strong>

                <p class="text-muted">${userProfilePageData.user.bio}</p>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="post">
                    <!-- Post -->
                    <c:forEach var="event" items="${userProfilePageData.events}">
	                    <div class="post">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputName" placeholder="${userProfilePageData.user.firstName}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputEmail" placeholder="${userProfilePageData.user.email}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Contact Number</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName2" placeholder="${userProfilePageData.user.contactNumber}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputExperience" class="col-sm-2 col-form-label">Bio</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" id="inputExperience" placeholder="${userProfilePageData.user.bio}"></textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputSkills" class="col-sm-2 col-form-label">Birthdate</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputSkills" placeholder="${userProfilePageData.user.birthDate}">
                        </div>
                      </div>
                      <div class="form-group row">
